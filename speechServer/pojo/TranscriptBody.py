...
class TranscriptBody:
    ...
    """
    def __init__(self, task_id: int = None, result: str = None, speech_type: str = None, speech_id: str = None):
        ...
        Args:
            ...
            speech_type (str): [final,partial,error,end]
            each sentence conclude text and timestamp information.
        """
        self.task_id = task_id

        if speech_id == 'auto':
            self.speech_id = f"yuntrans-{IdWorker().get_id()}"
        else:
